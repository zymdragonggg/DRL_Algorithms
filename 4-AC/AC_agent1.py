'''
This is an AC algorithm which uses discounted reward to train critic network.
action: discrete
...
class AC:
    ...
    def learn(self):#一个episode一学习
        ...
        with tf.GradientTape(persistent = True) as tape:
            ...
            error = discounted_ep_r - state_v #用户训练ciritc网络
            ...
            actor_loss = -tf.reduce_mean(sa_prob * state_v) # log(p) * v(s)
