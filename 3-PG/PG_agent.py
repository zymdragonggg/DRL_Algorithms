...
class PolicyGradient:
    def __init__(
        ...
        self.saver = tf.train.CheckpointManager(self.ck_point, directory='./models', max_to_keep=5, checkpoint_name='zym_')
    ...
    def choose_action(self, s):
        ...
        action_prob = tf.nn.log_softmax(self.net(s)) #获得所有动作概率
    ...
    def store_transition(self, s, a, r, done):#保存整个episode
        self.ep_s.append(s)
        self.ep_a.append(a)
        self.ep_r.append(r)
    ...
    def learn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            all_action_prob = tf.nn.log_softmax(self.net(s)) #输出动作概率 
        ...
        self.ep_s, self.ep_a, self.ep_r, self.ep_d = [], [], [], [] #注意一定要清空。
